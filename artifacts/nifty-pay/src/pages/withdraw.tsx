...
const COUNTRY_INFO: Record<string, { flag: string; currency: string }> = {
  ...
  'Ivory Coast':   { flag: '🇨🇮', currency: 'XOF' },
  Mali:            { flag: '🇲🇱', currency: 'XOF' },
  'Burkina Faso':  { flag: '🇧🇫', currency: 'XOF' },
  Togo:            { flag: '🇹🇬', currency: 'XOF' },
  Benin:           { flag: '🇧🇯', currency: 'XOF' },
  Guinea:          { flag: '🇬🇳', currency: 'GNF' },
  'Sierra Leone':  { flag: '🇸🇱', currency: 'SLL' },
  Liberia:         { flag: '🇱🇷', currency: 'LRD' },
  Gambia:          { flag: '🇬🇲', currency: 'GMD' },
  // Africa · North
  Egypt:           { flag: '🇪🇬', currency: 'EGP' },
  Morocco:         { flag: '🇲🇦', currency: 'MAD' },
  Algeria:         { flag: '🇩🇿', currency: 'DZD' },
  Tunisia:         { flag: '🇹🇳', currency: 'TND' },
  Sudan:           { flag: '🇸🇩', currency: 'SDG' },
  // Africa · East
  ...
  Burundi:         { flag: '🇧🇮', currency: 'BIF' },
  Somalia:         { flag: '🇸🇴', currency: 'SOS' },
  // Africa · South & Central
  'South Africa':  { flag: '🇿🇦', currency: 'ZAR' },
  Zambia:          { flag: '🇿🇲', currency: 'ZMW' },
  Mozambique:      { flag: '🇲🇿', currency: 'MZN' },
  Zimbabwe:        { flag: '🇿🇼', currency: 'ZWG' },
  Botswana:        { flag: '🇧🇼', currency: 'BWP' },
  Namibia:         { flag: '🇳🇦', currency: 'NAD' },
  Malawi:          { flag: '🇲🇼', currency: 'MWK' },
  Angola:          { flag: '🇦🇴', currency: 'AOA' },
  'DR Congo':      { flag: '🇨🇩', currency: 'CDF' },
  Congo:           { flag: '🇨🇬', currency: 'XAF' },
  Gabon:           { flag: '🇬🇦', currency: 'XAF' },
  // Middle East
...
const ORDERED_COUNTRIES = [
  // Africa · West
  'Ghana', 'Nigeria', 'Senegal', 'Cameroon', 'Ivory Coast', 'Mali',
  ...
  // Africa · South & Central
  'South Africa', 'Zambia', 'Mozambique', 'Zimbabwe', 'Botswana',
  'Namibia', 'Malawi', 'Angola', 'DR Congo', 'Congo', 'Gabon',
  // Middle East
  'UAE',
  // Asia
...
const MOBILE_MONEY_NETWORKS: Record<string, string[]> = {
  ...
  'Ivory Coast':  ['Orange Money', 'Wave', 'MTN MoMo', 'Moov Money'],
  ...
  Gambia:         ['Africell Money', 'QMoney'],
  Algeria:        ['CCP (La Poste)', 'Baridimob'],
  Tunisia:        ['Poste Tunisienne', 'Orange Money'],
  Sudan:          ['Zain Cash', 'MTN MoMo'],
  Rwanda:         ['MTN MoMo', 'Airtel Money'],
  Burundi:        ['Lumicash', 'Ecocash'],
  Somalia:        ['EVC Plus (Hormuud)', 'ZAAD'],
  Zambia:         ['MTN MoMo', 'Airtel Money', 'Zoona'],
  Mozambique:     ['M-Pesa', 'Mkesh', 'e-Mola'],
  Zimbabwe:       ['EcoCash', 'OneMoney', 'InnBucks'],
  Botswana:       ['Orange Money', 'MyZaka (BTC)'],
  Namibia:        ['MTC MoMo', 'Blue Wallet'],
  Malawi:         ['Airtel Money', 'TNM Mpamba'],
  Angola:         ['Multicaixa Express', 'Meu Kamba'],
  'DR Congo':     ['M-Pesa (Vodacom)', 'Airtel Money', 'Orange Money'],
  Congo:          ['MTN MoMo', 'Airtel Money'],
